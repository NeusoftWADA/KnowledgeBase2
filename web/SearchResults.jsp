...
<div id="base" class="">
    <!-- 搜索框 (矩形) -->
    <div id="u250" class="ax_default box_2" data-label="搜索框">
    ...
    <div id="u252" class="ax_default" data-label="返回主页" data-left="344" data-top="57" data-width="70" data-height="63">
        ...
        <!-- 返回底框 (椭圆形) -->
        <div id="u253" class="ax_default ellipse" data-label="返回底框">
            <img id="u253_img" class="img " src="images/搜索页/返回底框_u195.png"/>
        </div>

        <!-- 返回图标 (图片) -->
        <div id="u254" class="ax_default _图片" data-label="返回图标">
            <img id="u254_img" class="img " src="images/个人信息页/返回按钮_u165.png"/>
        </div>
