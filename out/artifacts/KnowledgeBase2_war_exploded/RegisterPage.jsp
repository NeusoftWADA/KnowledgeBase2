...
<div id="base" class="">
    ...
    <div id="u311" class="ax_default _一级标题" data-label="注册">
        ...
        <div id="u311_text" class="text ">
            <p><span>注册</span></p><p><span><br></span></p>
        </div>
    </div>

    <!-- 注册按钮 (矩形) -->
    <div id="u312" class="ax_default primary_button" data-label="注册按钮">
        <input type="submit" id="u312_div" name="button" class="" value="登录" style=" color:#FFFFFF; ">
    ...
    <div id="u316" class="ax_default text_field" data-label="注册再次密码">
        <input id="u316_input" type="text" value="" name="id"/>
    </div>

    <!-- 注册账号 (文本框) -->
    <div id="u317" class="ax_default text_field" data-label="注册账号">
        <input id="u317_input" type="password" value=""name="upassword"/>
    </div>

    <!-- 注册密码 (文本框) -->
    <div id="u318" class="ax_default text_field" data-label="注册密码">
        <input id="u318_input" type="password" value="" name="repeat"/>
    </div>
    ...
    <!-- 注册成功 (组 合) -->
    <div id="u325" class="ax_default" data-label="注册成功" data-left="501" data-top="159" data-width="588" data-height="344">

        <!-- Unnamed (矩形) -->
        <div id="u326" class="ax_default box_3">
            <div id="u326_div" class=""></div>
            <div id="u326_text" class="text ">
                <p style="font-size:28px;"><span>已成功注册&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </span></p><p style="font-size:12px;"><span style="font-size:28px;">请点击返回登录</span><span style="font-size:16px;">&nbsp; &nbsp;&nbsp; </span><span>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </span></p>
            </div>
        </div>
        ...
        <!-- Unnamed (热区) -->
        <div id="u328" onclick="javascript:window.location.href='SignInPage.jsp';" class="ax_default">
        </div>
    </div>
    </form>
</div>
